...
import { getPlacePhotoUrlNew } from '../lib/google-apis/places-photo-new'

async function testPhotoAPINew() {
  console.log('🧪 Google Places API (New) Photo Testi\n')
  ...
  // Test photo name (database'den alınan örnek - Yeni API formatı)
  ...
  // Yeni API formatı ile URL oluştur
  const photoUrl = getPlacePhotoUrlNew(testPhotoName, apiKey, 600)
  console.log(`\n🌐 Photo URL (Yeni Format):`)
...
testPhotoAPINew().catch(console.error)
